                ...
                <section class="timeline">
                    ...
                    <div class="timeline-block">
                        ...
                        <div class="timeline-content">
                            <div class="card social-card share full-width ">
                                <div class="card-header clearfix">
                                    <h5 class="text-warning-dark pull-left fs-12">Stock Market <i
                                                class="fa fa-circle text-warning-dark fs-11"></i></h5>
...
@section('script')
    ...
    <script src="{{ url('script/timeline/timeline.js') }}" type="text/javascript"></script>
