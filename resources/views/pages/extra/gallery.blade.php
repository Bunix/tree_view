        ...
        <div class=" container    container-fixed-lg sm-p-l-0 sm-p-r-0">
            ...
            <div class="gallery">
                ...
                <div class="gallery-item first" data-width="1" data-height="1">
                    <!-- START PREVIEW -->
                    <img src="img/gallery/1.jpg" alt="" class="image-responsive-height">
                    <!-- END PREVIEW -->
                            ...
                            <div class="gradient-grey p-l-20 p-r-20 p-t-20 p-b-5">
                                ...
                                <div class="m-t-10">
                                    <div class="thumbnail-wrapper d32 circular m-t-5">
                                        <img width="40" height="40" src="img/profiles/avatar.jpg"
                                    ...
                                    <div class="pull-right m-t-10">
                                        <button class="btn btn-white btn-xs btn-mini bold fs-14" type="button">+
                                        </button>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                ...
                <div class="gallery-item " data-width="2" data-height="2">
                    ...
                    <div class="live-tile slide" data-speed="750" data-delay="4000" data-mode="carousel">
                        <div class="slide-front">
                            <img src="img/gallery/2_1.jpg" alt="" class="image-responsive-height">
                        </div>
                        <div class="slide-back">
                            <img src="img/gallery/2_2.jpg" alt="" class="image-responsive-height">
                        </div>
                    </div>
                    <!-- END PREVIEW -->
                    <!-- START ITEM OVERLAY DESCRIPTION -->
                        ...
                        <div class="overlayer-wrapper item-info more-content">
                            <div class="gradient-grey p-l-20 p-r-20 p-t-20 p-b-5">
                                <div class="">
                                    ...
                                    <h3 class="pull-right semi-bold text-white font-montserrat bold no-margin">
                                        $25.00</h3>
                                    <div class="clearfix"></div>
                ...
                <div class="gallery-item " data-width="1" data-height="1">
                    <!-- START PREVIEW -->
                    <img src="img/gallery/3.jpg" alt="" class="image-responsive-height">
                    <!-- END PREVIEW -->
                    <!-- START ITEM OVERLAY DESCRIPTION -->
                    <div class="overlayer bottom-left full-width">
                        <div class="overlayer-wrapper item-info ">
                ...
                <div class="gallery-item " data-width="1" data-height="1">
                    <!-- START PREVIEW -->
                    <img src="img/gallery/4.jpg" alt="" class="image-responsive-height">
                    <!-- END PREVIEW -->
                    <!-- START ITEM OVERLAY DESCRIPTION -->
                    <div class="overlayer bottom-left full-width">
                        <div class="overlayer-wrapper item-info ">
                ...
                <div class="gallery-item " data-width="1" data-height="1">
                    <!-- START PREVIEW -->
                    <img src="img/gallery/5.jpg" alt="" class="image-responsive-height">
                    <!-- END PREVIEW -->
                    <!-- START ITEM OVERLAY DESCRIPTION -->
                    <div class="overlayer bottom-left full-width">
                        <div class="overlayer-wrapper item-info ">
                ...
                <div class="gallery-item " data-width="1" data-height="1">
                    <!-- START PREVIEW -->
                    <img src="img/gallery/6.jpg" alt="" class="image-responsive-height">
                    <!-- END PREVIEW -->
                    <!-- START ITEM OVERLAY DESCRIPTION -->
                    <div class="overlayer bottom-left full-width">
                        <div class="overlayer-wrapper item-info ">
                ...
                <div class="gallery-item " data-width="1" data-height="1">
                    <!-- START PREVIEW -->
                    <img src="img/gallery/7.jpg" alt="" class="image-responsive-height">
                    <!-- END PREVIEW -->
                    <!-- START ITEM OVERLAY DESCRIPTION -->
                    <div class="overlayer bottom-left full-width">
                        <div class="overlayer-wrapper item-info ">
                ...
                <div class="gallery-item " data-width="1" data-height="1">
                    <!-- START PREVIEW -->
                    <img src="img/gallery/8.jpg" alt="" class="image-responsive-height">
                    <!-- END PREVIEW -->
                    <!-- START ITEM OVERLAY DESCRIPTION -->
                    <div class="overlayer bottom-left full-width">
                        <div class="overlayer-wrapper item-info ">
                ...
                <div class="gallery-item " data-width="1" data-height="1">
                    <!-- START PREVIEW -->
                    <img src="img/gallery/9.jpg" alt="" class="image-responsive-height">
                    <!-- END PREVIEW -->
                    <!-- START ITEM OVERLAY DESCRIPTION -->
                    <div class="overlayer bottom-left full-width">
                        <div class="overlayer-wrapper item-info ">
                ...
                <div class="gallery-item " data-width="1" data-height="1">
                    <!-- START PREVIEW -->
                    <img src="img/gallery/10.jpg" alt="" class="image-responsive-height">
                    <!-- END PREVIEW -->
                    <!-- START ITEM OVERLAY DESCRIPTION -->
                    <div class="overlayer bottom-left full-width">
                        <div class="overlayer-wrapper item-info ">
                ...
                <div class="gallery-item " data-width="1" data-height="1">
                    <!-- START PREVIEW -->
                    <img src="img/gallery/11.jpg" alt="" class="image-responsive-height">
                    <!-- END PREVIEW -->
                    <!-- START ITEM OVERLAY DESCRIPTION -->
                    <div class="overlayer bottom-left full-width">
                        <div class="overlayer-wrapper item-info ">
                ...
                <div class="gallery-item " data-width="1" data-height="1">
                    <!-- START PREVIEW -->
                    <img src="img/gallery/12.jpg" alt="" class="image-responsive-height">
                    <!-- END PREVIEW -->
                    <!-- START ITEM OVERLAY DESCRIPTION -->
                    <div class="overlayer bottom-left full-width">
                        <div class="overlayer-wrapper item-info ">
                ...
                <div class="gallery-item " data-width="1" data-height="1">
                    <!-- START PREVIEW -->
                    <img src="img/gallery/13.jpg" alt="" class="image-responsive-height">
                    <!-- END PREVIEW -->
                    <!-- START ITEM OVERLAY DESCRIPTION -->
                    <div class="overlayer bottom-left full-width">
                        <div class="overlayer-wrapper item-info ">
                ...
                <div class="gallery-item " data-width="1" data-height="1">
                    <!-- START PREVIEW -->
                    <img src="img/gallery/14.jpg" alt="" class="image-responsive-height">
                    <!-- END PREVIEW -->
                    <!-- START ITEM OVERLAY DESCRIPTION -->
                    <div class="overlayer bottom-left full-width">
                        <div class="overlayer-wrapper item-info ">
                    ...
                    <div class="row dialog__overview">
                        <div class="col-md-7 no-padding item-slideshow-wrapper full-height">
                            <div class="item-slideshow full-height">
                                <div class="slide" data-image="img/gallery/item-square.jpg">
                                </div>
                                <div class="slide" data-image="img/gallery/item-square.jpg">
                                </div>
                            </div>
                                ...
                                <div class="row row-xs-height">
                                    <div class="col-8 col-xs-height col-middle no-padding">
                                        <div class="thumbnail-wrapper d32 circular inline">
                                            <img width="32" height="32" src="img/profiles/2.jpg"
                                                 data-src="img/profiles/2.jpg"
                                                 data-src-retina="img/profiles/2x.jpg" alt="">
                                        </div>
                        ...
                        <div class="col-md-5 p-r-35 p-t-35 p-l-35 full-height item-description">
                            ...
                            <p class="fs-13">When it comes to digital design, the lines between functionality,
                                aesthetics, and psychology are inseparably blurred. Without the constraints of the
                                physical world, there’s no natural form to fall back on, and every bit of constraint and
                    ...
                    <div class="row dialog__footer bg-info-dark hidden-sm-down">
                                ...
                                <div class="row row-xs-height">
                                    <div class="col-7 col-xs-height col-middle no-padding">
                                        <div class="thumbnail-wrapper d48 circular inline">
                                            <img width="48" height="48" src="img/profiles/2.jpg"
                                                 data-src="img/profiles/2.jpg"
                                                 data-src-retina="img/profiles/2x.jpg" alt="">
                                        </div>
                                        <div class="inline m-l-15">
                        ...
                        <div class="col-md-5 full-height">
                            <ul class="recommended list-inline pull-right m-t-10 m-b-0">
                                <li>
                                    <a href="#"><img src="img/gallery/thumb-1.jpg"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="img/gallery/thumb-2.jpg"></a>
                                </li>
                                <li>
                                    <a href="#"><img src="img/gallery/thumb-3.jpg"></a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="quickview-wrapper" id="filters">
            <div class="padding-40 ">
                <a class="builder-close quickview-toggle pg-close" data-toggle="quickview"
                   data-toggle-element="#filters" href="#"></a>
...
@section('script')
    ...
    <script src="{{ url('script/gallery/gallery.js') }}" type="text/javascript"></script>
