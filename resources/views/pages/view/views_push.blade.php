                ...
                <div class="list-view-group-container">
                    ...
                    <ul>
                        ...
                        <li class="chat-user-list clearfix">
                            <a data-view-animation="push" data-view-port="#chat" data-navigate="view"
                               data-toggle-view="#chatView" class="" href="#">
                ...
                <div class="navbar navbar-default">
                    <div class="navbar-inner">
                        <a href="javascript:;" class="link text-master inline action p-l-10" data-navigate="view"
                           data-view-port="#chat" data-view-animation="push">
                ...
                <div class="chat-inner" id="my-conversation">
                    ...
                    <div class="message clearfix">
                        <div class="profile-img-wrapper m-t-5 inline">
                            <img class="col-top" width="30" height="30" src="img/profiles/avatar_small.jpg" alt=""
