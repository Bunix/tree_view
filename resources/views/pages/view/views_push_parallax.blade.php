                    ...
                    <ul>
                        ...
                        <li class="chat-user-list clearfix">
                            <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view"
                               data-toggle-view="#subView1" class="" href="#">
                        ...
                        <div data-init-list-view="ioslist" class="list-view boreded no-top-border">
                            <div class="list-view-group-container">
                                ...
                                <ul>
                                    <!-- BEGIN Chat User List Item  !-->
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#nestedView"
                    ...
                    <div class="view chat-view bg-white clearfix">
                        ...
                        <div class="navbar navbar-default">
                            <div class="navbar-inner">
                                <a href="javascript:;" class="link text-master inline action p-l-10"
                                   data-navigate="view"
                                   data-view-port="#nestedView" data-view-animation="push-parrallax">
                                    <i class="pg-arrow_left fs-12 v-align-middle"></i>
                                </a>
                                <div class="view-heading">
                                    Level 2
