            ...
            <div class="social " data-pages="social">
                ...
                <div class="jumbotron" data-pages="parallax" data-social="cover">
                    <div class="cover-photo">
                        <img alt="Cover photo" src="img/social/cover.jpg"/>
                    </div>
                        ...
                        <div class="day" data-social="day">
                            ...
                            <div class="card no-border bg-transparent full-width" data-social="item">
                                ...
                                <div class="container-fluid p-t-30 p-b-30 ">
                                    <div class="row">
                                            ...
                                            <div class="container-xs-height">
                                                <div class="row-xs-height">
                                                    ...
                                                    <div class="col-xs-height p-l-20">
                                                        ...
                                                        <p class="no-margin fs-16">is excited about the new pages design
                                                            framework
                                                        </p>
                                        ...
                                        <div class="col-lg-4">
                                            <p class="no-margin fs-16">Hi My Name is David Nester, &amp; heres my new
                                                pages user profile page</p>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <ul class="list-unstyled ">
                                                <li class="m-r-10">
                                                    <div class="thumbnail-wrapper d32 circular b-white m-r-5 b-a b-white">
                                                        <img width="35" height="35"
                                                             ...
                                                             data-src="img/profiles/1.jpg" alt="Profile Image"
                                                ...
                                                <li>
                                                    <div class="thumbnail-wrapper d32 circular b-white m-r-5 b-a b-white">
                                                        <img width="35" height="35"
                                                             data-src-retina="img/profiles/2x.jpg"
                                                             data-src="img/profiles/2.jpg" alt="Profile Image"
                                                ...
                                                <li>
                                                    <div class="thumbnail-wrapper d32 circular b-white m-r-5 b-a b-white">
                                                        <img width="35" height="35"
                                                             data-src-retina="img/profiles/3x.jpg"
                                                             data-src="img/profiles/3.jpg" alt="Profile Image"
                                                ...
                                                <li>
                                                    <div class="thumbnail-wrapper d32 circular b-white m-r-5 b-a b-white">
                                                        <img width="35" height="35"
                                                             data-src-retina="img/profiles/4x.jpg"
                                                             data-src="img/profiles/4.jpg" alt="Profile Image"
                                                             src="img/profiles/4.jpg">
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="thumbnail-wrapper d32 circular b-white m-r-5 b-a b-white">
                                                        <img width="35" height="35"
                                                             data-src-retina="img/profiles/5x.jpg"
                                                             data-src="img/profiles/5.jpg" alt="Profile Image"
                                                             src="img/profiles/5.jpg">
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="thumbnail-wrapper d32 circular b-white m-r-5 b-a b-white">
                                                        <img width="35" height="35"
                                                             data-src-retina="img/profiles/6x.jpg"
                                                             data-src="img/profiles/6.jpg" alt="Profile Image"
                                                             src="img/profiles/6.jpg">
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="thumbnail-wrapper d32 circular b-white m-r-5 b-a b-white">
                                                        <img width="35" height="35"
                                                             data-src-retina="img/profiles/7x.jpg"
                                                             data-src="img/profiles/7.jpg" alt="Profile Image"
                                                             src="img/profiles/7.jpg">
                                                    </div>
                                                </li>
                                                <li>
                            ...
                            <div class="card social-card share  col1" data-social="item">
                                ...
                                <div class="card-header clearfix">
                                    <div class="user-pic">
                                        <img alt="Profile Image" width="33" height="33"
                                             data-src-retina="img/profiles/5x.jpg"
                                             data-src="img/profiles/5.jpg" src="img/profiles/5x.jpg">
                                    </div>
                                ...
                                <div class="card-content">
                                    ...
                                    <img alt="Social post" src="img/social-post-image.png">
                                </div>
                            ...
                            <div class="card social-card share  col1" data-social="item">
                                ...
                                <div class="card-header clearfix">
                                    <div class="user-pic">
                                        <img alt="Profile Image" width="33" height="33"
                                             data-src-retina="img/profiles/8x.jpg"
                                             data-src="img/profiles/8.jpg" src="img/profiles/8x.jpg">
                                    </div>
                                    <h5>Jeff Curtis</h5>
                                    <h6>Shared a Tweet
                                        <span class="location semi-bold"><i
                            ...
                            <div class="card social-card share  col1" data-social="item">
                                ...
                                <div class="card-header clearfix">
                                    <div class="user-pic">
                                        <img alt="Profile Image" width="33" height="33"
                                             data-src-retina="img/profiles/4x.jpg"
                                             data-src="img/profiles/4.jpg" src="img/profiles/4x.jpg">
                                    </div>
                                    <h5>Andy Young</h5>
                            ...
                            <div class="card social-card share share-other col1" data-social="item">
                                ...
                                <div class="card-content">
                                    ...
                                    <img alt="Quote" src="img/social/quote.jpg">
                                </div>
                                <div class="card-description">
                                ...
                                <div class="card-header clearfix last">
                                    <div class="user-pic">
                                        <img alt="Profile Image" width="33" height="33"
                                             data-src-retina="img/profiles/7x.jpg"
                                             data-src="img/profiles/7.jpg" src="img/profiles/7x.jpg">
                                    </div>
                                    <h5>Tracy Brooks</h5>
                            ...
                            <div class="card social-card share share-other col1" data-social="item">
                                ...
                                <div class="card-content">
                                    ...
                                    <img alt="Person photo" src="img/social/person-1.jpg">
                                </div>
                                <div class="card-description">
                                    <p><a href="#">#TBT</a> :D</p>
                                </div>
                            ...
                            <div class="card social-card share  col1" data-social="item">
                                ...
                                <div class="card-header clearfix">
                                    <div class="user-pic">
                                        <img alt="Profile Image" width="33" height="33"
                                             data-src-retina="img/profiles/6x.jpg"
                                             data-src="img/profiles/6.jpg" src="img/profiles/6x.jpg">
                                    </div>
                            ...
                            <div class="card social-card share  col1" data-social="item">
                                ...
                                <div class="card-description">
                                    <p>There is nothing new under the sun, but there are lots of old things we don't
                                        know yet.
                                    </p>
                                    <div class="via">via Twitter</div>
                                </div>
                            ...
                            <div class="card social-card share  col1" data-social="item">
                                ...
                                <div class="card-description">
                                    ...
                                    <h3>111.25 <span class="text-success"><i
                                                    class="fa fa-sort-up small text-success"></i> 0.15 (0.13%)</span>
                                    </h3>
                                </div>
                                <div class="card-footer clearfix">
...
@section('script')
    ...
    <script src="{{ url('script/social/pages.social.js') }}" type="text/javascript"></script>

    <script src="{{ url('script/social/barActive.js') }}"></script>
