...
@section('content')
    ...
    <div class="page-content-wrapper content-builder" id="parallaxCoverpage">
        ...
        <div class="content">
                                ...
                                <div class="col-xl-5 col-lg-6">
                                    ...
                                    <div class="card card-transparent">
                                        ...
                                        <div class="card-block">
                                            <h3>One of the most underestimated elements of design is typography.
                                                However, it’s critical in both print and web media. We Made it Perfect
                                                in both.</h3>
                                            <p>This feature in our product specifically creates hinted fonts for various
                                                OS browsers; whether its Windows, Mac OSx, or ubuntu, it does it for
                                                all.</p>
                                            <br>
                                            <div>
            ...
            <!-- END JUMBOTRON -->
            <div class=" container    container-fixed-lg demo-container">
...
@section('script')
    ...
    <script src="{{ url('script/builder/builder/barActive.js') }}"></script>
