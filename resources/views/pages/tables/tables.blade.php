                        ...
                        <div class="col-xl-7 col-lg-6 ">
                            ...
                            <div class="full-height">
                                <div class="card-block text-center">
                                    <img class="image-responsive-height demo-mw-600" src="img/demo/tables.jpg"
                                         alt="">
                                </div>
                            </div>
                            <!-- END card -->
                        ...
                        <div class="col-xl-5 col-lg-6 ">
                            ...
                            <div class="card card-transparent">
                                ...
                                <div class="card-block">
                                    ...
                                    <p>Simplicity and user-freindliness define our stylized Tables, with the layout
                                        enabling any observer to grasp the basic information at a glance. </p>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover" id="basicTable">
                                ...
                                <tr>
                                    ...
                                    <td class="v-align-middle">
                                        <p>it is more then ONE nation/nationality as its fall name is The United Kingdom
                                            of Great Britain and North Ireland..</p>
                                    </td>
                                    <td class="v-align-middle">
                                        <p>Public</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="v-align-middle">
                                        <p>you want English, Scottish, Welsh, Irish, British, European or UK even a
                                            British (name other original country you came form or have roots to E.G. A
                                            British Japanese or a 5th generation</p>
                                    </td>
                                    <td class="v-align-middle">
                                        <p>Public</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="v-align-middle">
                                        <p>UK was on top of the art world 18-19 century had the best food, best cloths
                                            and best entertainment back then) it was a hyper nation</p>
                                    </td>
                                    <td class="v-align-middle">
                                        <p>Public</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="v-align-middle">
                                        <p>he world speaks English. Common law, Magna Carta and the Bill of Rights are
                                            its wonderful legacy</p>
                                    </td>
                                    <td class="v-align-middle">
                                        <p>Public</p>
                                    </td>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="stripedTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="v-align-middle"><a href="#" class="btn">United States</a><a href="#"
                                                                                                               class="btn">India</a>
                                        </td>
                                        <td class="v-align-middle">
                                    ...
                                    <tr>
                                        ...
                                        <td class="v-align-middle"><a href="#" class="btn">China</a><a href="#"
                                                                                                       class="btn">Africa</a>
                                        </td>
                                        <td class="v-align-middle">
                                    ...
                                    <tr>
                                        ...
                                        <td class="v-align-middle">
                                            <p>The world speaks English. Common law, Magna Carta and the Bill of
                                                Rights...
                                            </p>
                                        </td>
                                    </tr>
...
@section('script')
    ...
    <script src="{{ url('script/tables/tables.js') }}" type="text/javascript"></script>
