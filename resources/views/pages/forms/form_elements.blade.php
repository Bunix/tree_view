                        ...
                        <div class="col-xl-7 col-lg-6 ">
                            ...
                            <div class="card card-default">
                                <div class="card-block text-center">
                                    <img class="image-responsive-height demo-mw-600" src="img/demo/form_hero.gif"
                                         alt="">
                                </div>
                            </div>
                            <!-- END card -->
                        ...
                        <div class="card-block">
                            ...
                            <form class="" role="form">
                                ...
                                <div class="form-group  form-group-default required">
                                    ...
                                    <input type="email" class="form-control" placeholder="ex: some@example.com"
                                           required>
                                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-block">
                            ...
                            <p>Adding on top of existing browser controls, Bootstrap includes other useful form
                                components. Add text or buttons before or after any text-based input. Do note that
                                select elements are not supported here.</p>
                            <br>
                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p>Input form element sizes on defualt pages design, These are highly customizable.
                                        You can either chose the default or you can select Standard input elements</p>
                                    <form role="form">
                                        <div class="form-group form-group-default">
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <p>Our very own image-less pure CSS and retina compatible check box. These check boxes are
                                customized and aviable in all boostrap color classes</p>
                            <br>
                            <div class="checkbox ">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="checkbox check-success">
                                ...
                                <br>
                                <input type="checkbox" disabled="disabled" checked="checked" value="check2" name="check"
                                       id="check2">
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <p>Pure CSS radio button with a cool animation. These are available in all primary colors in
                                bootstrap
                            </p>
                            <br>
                        ...
                        <div class="col-lg-4">
                            ...
                            <p>Use of different color opacity helps to destigues between different states such as
                                disable
                            </p>
                            <br>
                            <div class="radio radio-primary">
                                ...
                                <input type="radio" disabled="disabled" checked="checked" value="ADisabled"
                                       name="ADisabled" id="ADisabled">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="checkbox" data-init-plugin="switchery" data-size="large"
                                           data-color="primary" checked="checked"/>
                                </div>
                            </div>
                        </div>
        ...
        <div class=" container    container-fixed-lg">
            ...
            <div class="card card-default">
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-md-4">
                            <p>We've simplified our dropdown buttons by getting rid of the dedicated dropdown associated
                                with them, this looks more clean and also available in all different colors</p>
                            <br>
                            ...
                            <br>
                            <br>
                            <p class="small">The button will be automatically sized according to the visible content
                                size. Make sure there is enough room for the hidden content to show</p>
                        </div>
                        <div class="col-md-4">
                            <h5>
                                Simple dropdowns
                            </h5>
                            <p>These are highly customizable dropdowns that come with search option for use to
                                search</p>
                            <form role="form">
                                <div class="form-group ">
        ...
        <div class=" container    container-fixed-lg">
            ...
            <div class="card card-default">
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-md-4">
                            <p>You the following input will give suggestion as you type, you can fetch your list from an
                                external data source.</p>
                            <br>
                            <div class="form-group">
                                <input class="typeahead form-control sample-typehead" type="text"
                        ...
                        <div class="col-md-4">
                            ...
                            <p>Want to customize how the data is display, you can do that too with tyephead custom
                                templates</p>
                            <br>
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <p>Date picker is powered by boostrap date picker, this is customized in way that it suites
                                our theme and design, Have a look!</p>
                            <br>
                        ...
                        <div class="col-lg-4">
                            ...
                            <p>Date range can be set by the same plugin, this is use full when taking two dates at a
                                time
                            </p>
                            <br>
                      ...
                      <span class="add-on input-group-addon"><i
                        ...
                        <div class="col-lg-4">
                            ...
                            <p>Some advance setting that you can do with this calender, like to start from years an
                                disable sections of dates</p>
                            <br>
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <p>These assure the user will never enter invalid phone no, email or anything that has a
                                pattern even without validations</p>
                            <br>
                            <div class="form-group">
                                <label>Date</label>
                        ...
                        <div class="col-lg-6">
                            ...
                            <p>Do you forget small things? here is something that helps to automatically placed
                                forgotten dollar signs, decimal places and even comma separates and many more!</p>
                            <br>
                            <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-block">
                            <p>Do you use tags to organize content on your site? This plugin will turn your boring tag
                                list into a magical input that turns each tag into a style-able object with its own
                                delete link.
                            </p>
                            <br>
...
@section('script')
    ...
    <script src="{{ url('script/forms/form_elements.js') }}" type="text/javascript"></script>
