                            ...
                            <div class="col-xl-7 col-lg-6 bg-white">
                                ...
                                <div class="full-height">
                                    <div class="card-block text-center">
                                        <img class="image-responsive-height demo-mw-500" src="img/demo/buttons_hero.gif"
                                             alt="">
                                    </div>
                                </div>
                                <!-- END card -->
                            ...
                            <div class="col-xl-5 col-lg-6">
                                ...
                                <div class="card card-transparent">
                                    ...
                                    <div class="card-block">
                                        <h3>A button consists of text and/or an image that clearly communicates what
                                            action will occur when it is pressed upon.</h3>
                                        <div>
                                            <div class="">
                    ...
                    <div class="card card-transparent">
                        ...
                        <div class="card-block">
                            <h5>Color can be a wonderful tool for making
                                ...
                                and more calming</h5>
                            <p>Color can be a wonderful tool for making your dashboard less stressful and more calming —
                                and it can have a significant impact on your mood and well-being, We made it with you in
                                mind</p>
                            <br>
                            <div class="row ">
                                <div class="col-lg-3">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-12 ">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-block">
                            ...
                            <p>Size Might vary from smaller screen to a larger screen. We made few sizes that are pixel
                                perfect and resposive</p>
                            <br>
                            <div class="row">
                                <div class="col-lg-6">
                                    <p>Size variation</p>
                                    <p class="small">
                                        Fancy larger or smaller buttons? Add .btn-lg .btn-sm .btn-xs for additional
                                        sizes.
                                    </p>
                                </div>
                                <div class="col-lg-6">
                ...
                <div class="col-xl-4 col-lg-12 ">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-block">
                            <p>Button groups can act as a radio or a switch or even a single toggle. Below are some
                                examples click to see what happens
                            </p>
                            <div class="m-t-15">
                                <button type="button" class="btn btn-complete" data-toggle="button">Single toggle
                                </button>
                                <br>
                                <br>
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-block">
                            ...
                            <p class="small">The button will be automatically sized according to the visible content
                                size. Make sure there is enough room for the hidden content to show
                                <br><code>btn-animated</code> and diirection as <code>from-left</code> or
                                <code>from-top</code>
                            </p>
                            <div class="m-t-15">
                                <button type="button"
                                        class="btn btn-primary btn-cons btn-animated from-left pg pg-mail">
                                    <span>Follow us</span>
                                </button>
                                <button type="button"
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-6 col-md-12">
                            ...
                            <div class="card card-transparent">
                                ...
                                <div class="card-block">
                                    <p>We've simplified our dropdown buttons by getting rid of the dedicated dropdown
                                        associated with them, this looks more clean and also available in all different
                                        colors</p>
                                    <br>
                                    ...
                                    <br>
                                    <br>
                                    <p class="small">The button will be automatically sized according to the visible
                                        content size. Make sure there is enough room for the hidden content to show</p>
                                </div>
                            </div>
                            <!-- END card -->
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-12">
                            ...
                            <div class="card card-transparent">
                                ...
                                <div class="card-block">
                                    ...
                                    <br>
                                    <button class="btn btn-default btn-lg btn-rounded m-r-20 m-b-10">Big rounded
                                    </button>
                                    <button class="btn btn-lg btn-rounded btn-primary m-r-20 m-b-10">Big rounded
                                    </button>
                                    <br>
                                    ...
                                    <br>
                                    <br>
                                    <p class="small">Circular buttons are a special type of promoted action. It
                                        Distinguish a different action or a style.</p>
                                </div>
                            </div>
                            <!-- END card -->
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-12">
                            ...
                            <div class="card card-transparent">
                                ...
                                <div class="card-block">
                                    <p>Basic example of bootstrap button groups. Wrap a series of buttons with
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-12">
                            ...
                            <div class="card card-transparent">
                                ...
                                <div class="card-block">
                                    <p>A button bar is a group of button groups, perfect for situations where you want
                                        groups of actions that are all related to a similar element or page</p>
                                    <br>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-12">
                            ...
                            <div class="card card-transparent">
                                ...
                                <div class="card-block">
                                    <p>Want it in a different perspective? its customized to work both vertical and
                                        horizontal ways</p>
                                    <br>
                                    ...
                                    <div class="btn-group-vertical">
                                        ...
                                        <div class="">
                                            <div class="dropdown dropdown-default">
                                                <button class="btn btn-secondary dropdown-toggle text-center"
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-block">
                            <p>Basic buttons are traditional buttons with borders and background with an extra component
                                like an icon. You can place it either on the left or the right which ever you want with
                                different color options</p>
                            <br>
                            <button class="btn btn-primary btn-cons m-b-10" type="button"><i class="pg-form"></i> <span
                            ...
                            <button class="btn btn-info btn-cons m-b-10" type="button"><i class="fa fa-paste"></i> <span
                                        class="bold">Edit</span>
                            </button>
                            ...
                            <!-- Indicates a dangerous or potentially negative action -->
                            <button class="btn btn-default btn-cons m-b-10" type="button"><i class="pg-map"></i> Map
                            </button>
                        </div>
                    </div>
                    <!-- END card -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-block">
                            <p>Fancy social icons? here are some of pre-made icons and buttons done by use which can
                                come in handy</p>
                            <br>
