                        ...
                        <div class="col-xl-7 col-lg-6 ">
                            ...
                            <div class="full-height">
                                <div class="card-block text-center">
                                    <img class="image-responsive-height demo-mw-600" src="img/demo/tab.png"
                                         alt="">
                                </div>
                            </div>
                            <!-- END card -->
                ...
                <div class="col-lg-6">
                    <div class="card card-borderless">
                        <ul class="nav nav-tabs nav-tabs-simple" role="tablist" data-init-reponsive-tabs="dropdownfx">
                            <li class="nav-item">
                                <a class="active" data-toggle="tab" role="tab" data-target="#tab2hellowWorld" href="#">Hello
                                    World</a>
                            </li>
                            <li class="nav-item">
                                        ...
                                        <div class="row column-seperation">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <p>Native boostrap tabs customized to Pages look and feel, simply
                                                    changing class name you can change color as well as its
                                                    animations</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane " id="tab4FollowUs">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <br>
                                                <p class="pull-right">
                                                    <button type="button" class="btn btn-default btn-cons">White
                                                    </button>
                                                    <button type="button" class="btn btn-success btn-cons">Success
                                                    </button>
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-transparent">
                                ...
                                <ul class="nav nav-tabs nav-tabs-linetriangle" data-init-reponsive-tabs="dropdownfx">
                                    ...
                                    <li class="nav-item">
                                        <a data-toggle="tab" data-target="#messages"
                                           href="#"><span>Hello Three</span></a>
                                    </li>
                                </ul>
                                <!-- Tab panes -->
                                <div class="tab-content">
