                            ...
                            <div class="col-xl-7 col-lg-6 bg-white">
                                ...
                                <div class="full-height">
                                    <div class="card-block text-center">
                                        <img class="image-responsive-height demo-mw-350"
                                             src="img/demo/colors_hero.gif" alt="">
                                    </div>
                                </div>
                                <!-- END card -->
                            </div>
                            <div class="col-xl-5 col-lg-6 col-top">
                                ...
                                <div class="card card-transparent">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <p>Color is a wonderful tool for making your dashboard more interesting with a
                                            significant positive impact on your mood. </p>
                                        <br>
                                        <div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="card card-transparent">
                        ...
                        <div class="card-block">
                            <p>The dashboard will synergize with the colour selection made by the user and appropriately
                            ...
                            <div>
                                ...
                                <p class="no-margin p-l-30">
                                    <a href="http://pages.revox.io/swatches.zip">Download full color pallete
                                        (swatches)</a>
                                </p>
                    ...
                    <div class="col-md-5 offset-md-1">
                        ...
                        <div class="card card-transparent">
                            <div class="card-block">
                                ...
                                <div class="clearfix"></div>
                                <br>
                                <p>With a coterie of features based on zero- saturation resulting in mutilple colour
                                    adaptability, this colour is the essential Master colour which affects the fonts,
                                    background and content. The upper dark shades are made having the master base color
                                    on top of a black (#000000) with certain opacity. Thus the lower light shades are
                                    made with a white (#ffffff) color .</p>
                                <br>
                                <p class="small">NOTE: Changing the base color will change the other shades of the
                                    relative base.</p>
                            </div>
                        </div>
                        <!-- END card -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-transparent">
                        ...
                        <div class="card-block">
                            ...
                            <p>The monochrome base color is made by having a zero saturation percentage which will
                                adapat to any color placed near it.</p>
                            <h5>Easy code</h5>
