            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-default">
                            ...
                            <input type="text" name="name" id="personName" placeholder="username" class="form-control"
                                   required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group form-group-default">
                            <label>E-mail</label>
                            <input type="email" name="email" id="personEmail" placeholder="email" class="form-control"
                                   required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-default">
                            ...
                            <input type="text" name="password" id="person_id" placeholder="personId"
                ...
                <div class="row">
                    <div class="col-lg-12" style="height: 50px">
                        <button onclick="create_user()" class="btn btn-xs btn-success btn-cons m-t-10" type="button">New
                            Person
                        </button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-default">
                            ...
                            <input type="text" name="image_url" id="image_url" placeholder="Url image"
                                   class="form-control"
                                   required>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 text-left">
                        <img src="" id="returnImage" style="width: 100%; height: auto;"/>
                    </div>
                    <div class="col-lg-6 text-right">
                        <button onclick="view_image()" class="btn btn-xs btn-default btn-cons m-t-10" type="button">View
                            Image
                        </button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 no-padding sm-p-l-10">
                        <button onclick="sendPersonFace()" class="btn btn-xs btn-complete btn-cons m-t-10"
                                type="button">Add Person
                        </button>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 d-flex align-items-center justify-content-end">
                        <button id="create_person" onclick="trainPerson()"
                                class="btn btn-sm btn-primary btn-cons m-t-10" type="submit" disabled>Create a new user
                        </button>
                    </div>
                </div>
            </form>
...
@section('script_view')
    <script src="{{ url('script/register/register.js') }}"></script>
@stop
