<div class="header-inner header-md-height">
    ...
    <div class="">
        <div class="brand inline no-border hidden-xs-down">
            <img src="img/logo_white.png" alt="logo" data-src="img/logo_white.png"
                 data-src-retina="img/logo_white_2x.png" width="78" height="22">
        </div>
                                ...
                                <div class="notification-item unread clearfix">
                                    <div class="heading">
                                        <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                                            <img width="30" height="30" data-src-retina="img/profiles/1x.jpg"
                                                 data-src="img/profiles/1.jpg" alt="" src="img/profiles/1.jpg">
                                        </div>
                                        <a href="#" class="text-complete pull-left">
        ...
        <div class="dropdown pull-right">
            <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true"
              ...
              <span class="thumbnail-wrapper d32 circular inline sm-m-r-5">
                <img src="img/profiles/avatar.jpg" alt="" data-src="img/profiles/avatar.jpg"
                     data-src-retina="img/profiles/avatar_small2x.jpg" width="32" height="32">
                </span>
            </button>
